...
public class NumericToWord {
    ...
    static public class DefaultProcessor extends AbstractProcessor {
        ...
        public String CurrencyPrefix = "Dollars";
        public String CurrenncySuffix = "Cents";
